...
for key, group in grouped:
    ...
    # collect
    sp_stats = {'od_id': key, 'length': sp['length'], 'mdB': sp['mdB'], 'nei': sp['nei'], 'nei_norm': sp['nei_norm'], 'util': sp['util'], '60dBl': sp['60dBl'], '65dBl': sp['65dBl'] }
...
#%% calculate 65db stats for 600-1000 len paths
db65r_0_20 = od_stats_len_600_1000[od_stats_len_600_1000['65dBr'] > 0 and od_stats_len_600_1000['65dBr'] <= 20]
