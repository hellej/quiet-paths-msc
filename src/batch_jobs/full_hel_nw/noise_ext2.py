...
edge_chunks = utils.get_list_chunks(edge_set, 3000)
...
# EXPORT GRAPH
ox.save_graphml(graph, filename='hel_u_g_n2_f_s.graphml', folder='graphs', gephi=False)
...
edge_time = round(time_elapsed/len(edge_set), 5)
